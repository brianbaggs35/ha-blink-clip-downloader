...
<template>
  <Card>
    <template #title><h3 style="margin: 0; font: inherit; color: inherit">Email Alerts</h3></template>
    <template #content>
      ...
      <div v-else>
        <Button size="small" severity="secondary" outlined :disabled="sending" @click="sendTestEmail">
