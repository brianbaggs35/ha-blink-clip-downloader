...
<template>
  <Card>
    <template #title><h3 style="margin: 0; font: inherit; color: inherit">🧠 Adaptive Learning</h3></template>
    <template #content>
      <div style="font-size: 0.85rem">
        ...
        <div style="color: var(--muted); font-size: 0.78rem">
          <template v-if="stats && stats.total > 0">
            {{ stats.false_positive || 0 }} false positive(s), {{ stats.false_negative || 0 }} false negative(s)
            reported
          </template>
