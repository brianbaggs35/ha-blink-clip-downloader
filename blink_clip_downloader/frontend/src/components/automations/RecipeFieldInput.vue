...
<template>
  <div class="recipe-field" :class="{ 'recipe-field-toggle': field.type === 'toggle' }">
    ...
    <div class="recipe-field-input">
      ...
      <InputMask
        ...
        class="recipe-wide"
      />
      <InputText v-else v-model="textModel" :input-id="inputId" :placeholder="field.placeholder" class="recipe-wide" />
    </div>
