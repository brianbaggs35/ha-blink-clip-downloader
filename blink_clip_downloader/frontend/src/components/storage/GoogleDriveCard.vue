    ...
    <Card class="gdrive-setup-card">
      <template #title>
        <span class="gdrive-title">
          <svg viewBox="0 0 24 22" width="20" height="18" aria-hidden="true" class="gdrive-mark">
            <polygon points="12,3 3,19 12,13.7" fill="#1a73e8" />
            <polygon points="12,3 21,19 12,13.7" fill="#12a150" />
            <polygon points="3,19 21,19 12,13.7" fill="#f2b400" />
          </svg>
          Google Drive Setup
        </span>
      </template>
