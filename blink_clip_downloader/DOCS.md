...
An embedded Security Feed shows whatever the Security Feed tab itself is set
to — the same cameras, tiles per row and refresh interval — so change it
there and every embed follows.
